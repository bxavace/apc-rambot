![](media/image1.jpg){width="5.496666666666667in" height="8.5in"}
...
+-------------------------------------------------------------+--------+
| > E-mail and Network Accounts                               | 51     |
+=============================================================+========+
...
|                                                             |        |
| Guidelines for Reserving/Using Computer Laboratories, Audio |        |
+-------------------------------------------------------------+--------+
| > Recording Studios, Photography, and Videography Studio    | 60     |
+-------------------------------------------------------------+--------+
...
+------------------------------------------------------------------+---------+
| > **Sexual Harassment Cases**                                    | **157** |
|                                                                  |         |
| **XIX. APPENDICES**                                              |         |
+==================================================================+=========+
| > Appendix A: Anti-Sexual Harassment Act of 1995                 | 159     |
+------------------------------------------------------------------+---------+
...
+-------------------+-------------------------------------------------+
| Solution Provider | Applies knowledge, concepts, theories, and      |
|                   | industry-based skills in order to identify,     |
|                   | solve, and recommend solutions aligned to the   |
|                   | goals of its users and the organization to      |
|                   | which they operate                              |
|                   |                                                 |
|                   | Develops ideas and solutions with creativity    |
|                   | and innovation, and with appropriate            |
|                   | considerations to ethical, cultural, and        |
|                   | environmental factors                           |
+===================+=================================================+
| Committed         | Fulfills commitments, made to one's self and    |
|                   | the organization, beyond expectations           |
|                   |                                                 |
|                   | Copes with the demands of goals, commitments,   |
|                   | and rvonsibilities even when faced with         |
|                   | unexpected situations                           |
+-------------------+-------------------------------------------------+
| IT Enabled        | Uses innovative methods and appropriate         |
|                   | technologies to perform tasks effectively and   |
|                   | efficiently                                     |
+-------------------+-------------------------------------------------+
| Customer-oriented | Understands the needs of customers and          |
|                   | audiences, as well as the intent and spirit of  |
| Professional      | their requirements, in order to respond         |
|                   | appropriately in verbal and nonverbal forms     |
+-------------------+-------------------------------------------------+
| Team Player       | Functions effectively as an individual and as a |
|                   | member of diverse teams in multidisciplinary    |
|                   | settings by respecting and recognizing          |
|                   | individual and cultural differences and         |
|                   | strengths                                       |
|                   |                                                 |
|                   | Encourages, motivates, and inspires others to   |
|                   | perform, cooperate, and achieve team goals      |
+-------------------+-------------------------------------------------+
| Good              | Communicates effectively and ethically using    |
...
| Professional      |                                                 |
+-------------------+-------------------------------------------------+
| Contributor to    | Recognizes the needs of society, and            |
|                   | contributes ideas to address societal concerns  |
| Nation Building   | and issues for the betterment of the nation and |
|                   | its citizens                                    |
+-------------------+-------------------------------------------------+
| Lifelong Learner  | Recognizes the fast-paced demands of industry,  |
|                   | allowing one to formulate personal goals        |
|                   | aligned to organizational goals in order to     |
|                   | determine plans of action to improve one's      |
|                   | performance and capability; possesses the       |
|                   | ability to engage in independent and life-long  |
|                   | learning in the broadest context of             |
|                   | technological change; determines one's          |
|                   | developmental needs through self-assessment     |
+-------------------+-------------------------------------------------+
...
+======================+======================+======================+
| Academic activities  | Classrooms, lecture  | Mondays through      |
| such as              | hall,                | Fridays:             |
| advanced/make-up     |                      |                      |
| classes,             | MPH1, and MPH2       | 7:00 a.m. to 8:00    |
| out-of-class         |                      | p.m.                 |
| presentations/       |                      |                      |
| defense, and         |                      | Saturdays:           |
| computer lab work.   |                      |                      |
|                      |                      | 7:00 a.m. to 5:30    |
|                      |                      | p.m.                 |
+----------------------+----------------------+----------------------+
| Extracurricular      | Auditorium, MPH1,    | > Mondays through    |
| activities such as   | and                  | > Fridays 7:00 a.m.  |
| exhibits, film       |                      | > to 9:00 p.m.       |
| showing, contests,   | MPH2                 |                      |
...
|                      |     weighted average |     Grade 10/4th yr. |
|                      |     grade of at      |     report card      |
|                      |     least 85%        |                      |
|                      |                      | -   Certificate of   |
|                      | -   No grade lower   |     Good Moral       |
|                      |     than 85 in       |     Character        |
|                      |                      |                      |
|                      | > all subject areas  |                      |
|                      |                      |                      |
|                      | -   Graduates of     |                      |
...
|                      | Alternative Learning |     Result           |
|                      | System (ALS) with    |                      |
|                      | A&E Percent Correct  | -   ALS              |
|                      | (PC) not lower than  |     certification    |
|                      | 85% in Part II       |     from DepEd       |
|                      | (Communication       |                      |
|                      | Skills in English)   | -   Recommendation   |
|                      | and Part III         |     letter from the  |
|                      | (Critical            |     ALS Supervisor   |
|                      |                      |                      |
|                      | Thinking and         |                      |
|                      | Problem-             |                      |
|                      |                      |                      |
...
|                      | income of family in  |     submit latest    |
|                      | the same household   |     Income Tax       |
|                      | is less than         |     Return (ITR) and |
|                      |                      |     Certificate of   |
|                      | > P250,000           |     Employment that  |
|                      |                      |     states the       |
|                      |                      |     present salary   |
|                      |                      |     and position.    |
|                      |                      |                      |
...
|                      | > siblings.          |                      |
+----------------------+----------------------+----------------------+
| > SM FOUNDA          | TION SCHOLAR (SMF)   |                      |
+----------------------+----------------------+----------------------+
| > 100%               | > For the complete   | > *NOTE: Students    |
|                      | > list of details,   | > should directly    |
|                      | > students may view  | > apply via the      |
|                      | > https://www.       | > Customer Service   |
|                      | > sm-foundati        | > of any SM          |
|                      | on.org/what\_we\_do/ | > Department Store*  |
|                      | > college-           |                      |
|                      | scholarship-program/ |                      |
|                      | > for further        |                      |
|                      | > information.       |                      |
...
|                      |     employees below  | > by their           |
|                      |     supervisory      | > respective Human   |
|                      |     level            | > Resources          |
|                      |                      | > Department and     |
|                      | > •                  | > valid SM           |
|                      |                      | > identification     |
...
|                      |                      |                      |
+----------------------+----------------------+----------------------+
| > AFP OFFICE         | R'S LADIES CLUB      | HIP (AFPOLC)         |
|                      | SCHOLARS             |                      |
+----------------------+----------------------+----------------------+
...
|                      |                      | SUBMITTED            |
+----------------------+----------------------+----------------------+
| ACTIVE UNIFORMED PNP |                      |                      |
+----------------------+----------------------+----------------------+
| 60%                  | Children of active   | Clearance signed by  |
|                      | uniformed            | the Inspector        |
|                      |                      | General or           |
|                      | Philippine National  | authorized personnel |
|                      | Police (PNP)         | of the Internal      |
|                      |                      | Affairs              |
|                      | Personnel            |                      |
|                      |                      | Services of the      |
|                      |                      | Philippine           |
...
| (AFP-EBS)            |                      |                      |
+----------------------+----------------------+----------------------+
| 100%                 | Children of KIA      | Original endorsement |
|                      | (Killed-In-Action)   | letter               |
| (Tuition fee only)   | personnel, WIA       |                      |
|                      | (Wounded-InAction)   | signed by AFPEBS'    |
|                      | personnel, CDD-CR    | chief/general        |
|                      |                      | manager              |
|                      | (Complete Disability |                      |
|                      | Discharge -          |                      |
|                      | Comb                 |                      |
...
| ASSISTANCE           |                      |                      |
+----------------------+----------------------+----------------------+
| 35%                  | High school graduate | A certification from |
|                      | (who has not         | the High School      |
|                      | attended any         | Principal or         |
|                      | college/university)  | Registrar which      |
|                      | of any parish school | indicates that       |
...
|                      |                      | verifies that        |
|                      |                      | his/her annual       |
|                      |                      | tuition is less than |
|                      |                      | P35,000              |
+----------------------+----------------------+----------------------+
| 20%                  |                      | A certification from |
|                      |                      | the High School      |
|                      |                      | Principal or         |
|                      |                      | Registrar which      |
|                      |                      | indicates that       |
...
+-------------------+-----------------+----------------+-----------------+
| Grade Components  | > CORE Subjects | Academic Track |                 |
+===================+=================+================+=================+
|                   |                 | All other      | Work Immersion/ |
|                   |                 |                |                 |
|                   |                 | Subjects       | Culminating     |
|                   |                 |                |                 |
|                   |                 | (Applied and   | Activity        |
|                   |                 |                |                 |
|                   |                 | Specialized)   |                 |
+-------------------+-----------------+----------------+-----------------+
...
+==================================+==================================+
| Monday through Friday 8:00 a.m.  | P100/equipment/hour              |
| to 8:00 p.m.                     |                                  |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| Monday through Friday 8:01 p.m.  | P250/equipment for the whole     |
| to 7:59 a.m.                     | evening                          |
+----------------------------------+----------------------------------+
...
résumés and scheduling business writing workshops in preparation for the
internship program. It also edits student theses and proofreads journal
articles.
...
+==================================+==================================+
| > 7:30 a.m. - 12:00 p.m. 1:00    | > Subject to SoE Laboratory      |
| > p.m. - 5:30 p.m.               | > course offering schedules      |
+----------------------------------+----------------------------------+
...
([https://library.apc. edu.ph]{.underline}) to check for available
resources.
...
library website ([https://library.apc.edu.ph/]{.underline}) and library
Facebook page ([https://www.facebook.com/APCLibrary]{.underline}). The
librarian assigned shall consolidate all inquiries and endorse them to
the appropriate persons to answer as needed. This service will
...
### [During Hyflex Implementation]{.underline}
...
1.  Student who will not enroll for INTERN2 to complete the Internship
    ...
    a.  *Letter of Request* addressed to the Executive Director of the
        School that the Intern belongs to

    b.  Duplicate copy of the *Resignation Letter* that is submitted to
...
2.  The intern shall abide by the company rules of the concerned
    ...
    b.  Interns who are terminated will receive a failing mark (below75)
        for the course.
...
![](media/image2.jpg){width="7.510001093613298in"
height="4.224375546806649in"}

![](media/image3.jpg){width="7.510001093613298in"
height="4.224375546806649in"}

![](media/image4.jpg){width="7.5in" height="4.21875in"}

![](media/image5.jpg){width="7.5in" height="4.21875in"}

![](media/image6.png){width="7.5033344269466316in" height="4.04in"}

ADDENDUM: APC Wave Protocol AY 2023-2024 (For Graduate Students)
----------------------------------------------------------------

![](media/image7.jpg){width="7.5in" height="4.21875in"}

![](media/image8.jpg){width="7.5in" height="4.21875in"}

![](media/image9.jpg){width="7.5in" height="4.21875in"}
...
![](media/image10.png){width="4.506667760279965in" height="2.53in"}To
the extent permitted by law, all those assigned to handle the complaint
in their capacity as Board members or Executive Directors, will treat
with strict confidentiality all matters and information that are
disclosed to them. Disclosure will be permitted only if deemed
appropriate by the majority of the Board. The Board will make every
attempt to establish the veracity of a complaint. This is done while
respecting the confidentiality and protecting the rights of both
parties.
...
C.  Guidance Office Head D. Discipline Office Head
...
+----------------+---------+------------+-----------+----------------+
| > MAJOR        | REF No. | 1st        | 2nd       | 3rd            |
| > OFFENSES     |         |            |           |                |
|                |         | > OFFENSE  | > OFFENSE | > OFFENSE      |
+================+=========+============+===========+================+
| Any act that   | 7.4.1   | 3, 5 and 6 | 7 or 8    |                |
| endangers      |         |            |           |                |
|                |         |            |           |                |
| the life or    |         |            |           |                |
| security of    |         |            |           |                |
...
| values of APC  |         |            |           |                |
+----------------+---------+------------+-----------+----------------+
| Cutting        | 7.4.2   | 1          | 1         | > 3 and (4 or  |
| classes (for   |         |            |           | > 6)           |
|                |         |            |           |                |
| Senior High    |         |            |           | (Refer to      |
| School)        |         |            |           |                |
|                |         |            |           | 7.4.22)        |
+----------------+---------+------------+-----------+----------------+
...
| 1995           |         |            |           |                |
+----------------+---------+------------+-----------+----------------+
| Making sexual  | 7.4.5   | 3, 5 and 6 | 7 or 8    |                |
| advances in    |         |            |           |                |
| words or deeds |         |            |           |                |
| to any member  |         |            |           |                |
| of the APC     |         |            |           |                |
...
+----------------------+---------+------------+-----------+-----------+
| > MAJOR OFFENSES     | REF No. | 1st        | 2nd       | 3rd       |
|                      |         |            |           |           |
|                      |         | > OFFENSE  | > OFFENSE | > OFFENSE |
+======================+=========+============+===========+===========+
| Physical assault on  | 7.4.6   | 3, 5 and 6 | 7 or 8    |           |
| any individual or    |         |            |           |           |
| getting involved in  |         |            |           |           |
| a physical fight     |         |            |           |           |
| with anyone within   |         |            |           |           |
...
| campus               |         |            |           |           |
+----------------------+---------+------------+-----------+-----------+
| Vandalism or         | 7.4.7   | 4 and 5    | 3 and 6   | 7 or 8    |
| destruction of       |         |            |           |           |
| property belonging   |         |            |           |           |
| to the school or to  |         |            |           |           |
| any member of the    |         |            |           |           |
...
+----------------------+---------+------------+-----------+-----------+
| Use, possession, or  | 7.4.9   | 7, 8 or 9  |           |           |
|                      |         |            |           |           |
| distribution of      |         |            |           |           |
| prohibited drug      |         |            |           |           |
| substances and       |         |            |           |           |
...
|                      |          | > OFFENSE | > OFFENSE | > OFFENSE |
+======================+==========+===========+===========+===========+
| Unauthorized         | > 7.4.10 | 5 and 6   | 7, 8 or 9 |           |
| possession and/or    |          |           |           |           |
| drinking of          |          |           |           |           |
| alcoholic beverages  |          |           |           |           |
| inside and/ or       |          |           |           |           |
...
| beverage             |          |           |           |           |
+----------------------+----------+-----------+-----------+-----------+
| Unauthorized use     | > 7.4.11 | 5 and 6   | 7 or 8    |           |
|                      |          |           |           |           |
| of school            |          |           |           |           |
| facilities,          |          |           |           |           |
| documents, or        |          |           |           |           |
| equipment            |          |           |           |           |
+----------------------+----------+-----------+-----------+-----------+
| Violation of         | > 7.4.12 | 5 and 6   | 7 or 8    |           |
| policies and         |          |           |           |           |
| regulations          |          |           |           |           |
| regarding            |          |           |           |           |
|                      |          |           |           |           |
...
| facilities           |          |           |           |           |
+----------------------+----------+-----------+-----------+-----------+
| Acts of lewdness,    | > 7.4.13 | 5 and 6   | 7 or 8    |           |
| commission of any    |          |           |           |           |
| act of immorality,   |          |           |           |           |
| or the display or    |          |           |           |           |
| distribution of      |          |           |           |           |
...
| college              |          |           |           |           |
+----------------------+----------+-----------+-----------+-----------+
| Stealing, whether    | > 7.4.14 | 5 and 6   | 7 or 8    |           |
| attempted,           |          |           |           |           |
| frustrated, or       |          |           |           |           |
| consummated; failure |          |           |           |           |
| to turn over lost    |          |           |           |           |
...
| unsanctioned use    |          |            |           |           |
+---------------------+----------+------------+-----------+-----------+
| Gross acts of       | > 7.4.16 | 3, 5 and 6 | 7, 8 or 9 |           |
| disrespect, in      |          |            |           |           |
| words or in deeds,  |          |            |           |           |
| that tend to put    |          |            |           |           |
| any member of the   |          |            |           |           |
...
|                     |          | > OFFENSE  | > OFFENSE | > OFFENSE |
+=====================+==========+============+===========+===========+
| Acts that tend to   | > 7.4.17 | 3, 5 and 6 | 7, 8 or 9 |           |
| destroy the good    |          |            |           |           |
| name of the         |          |            |           |           |
| College, such as    |          |            |           |           |
| public and          |          |            |           |           |
...
| name of the College |          |            |           |           |
+---------------------+----------+------------+-----------+-----------+
| Gambling in any     | > 7.4.18 | 3 and 6    | 7 or 8    |           |
| form                |          |            |           |           |
|                     |          |            |           |           |
| within the College  |          |            |           |           |
| premises            |          |            |           |           |
+---------------------+----------+------------+-----------+-----------+
| Membership in any   | > 7.4.19 | 7, 8 or 9  |           |           |
|                     |          |            |           |           |
| fraternity,         |          |            |           |           |
| sorority, or gang;  |          |            |           |           |
| conspiration or     |          |            |           |           |
...
|              |          | > OFFENSE    | > OFFENSE    | > OFFENSE |
+==============+==========+==============+==============+===========+
| Intentional  | > 7.4.20 | > 3 and 6    | > 7 or 8     |           |
| ins          |          |              |              |           |
| ubordination |          |              |              |           |
| or refusal   |          |              |              |           |
| to follow    |          |              |              |           |
...
| single term  |          |              |              |           |
+--------------+----------+--------------+--------------+-----------+
| Threatening  | > 7.4.23 | > 3, 5 and 6 | > 7 or 8     | > A or B  |
| another with |          |              |              |           |
| infliction   |          |              |              |           |
| upon his     |          |              |              |           |
| person,      |          |              |              |           |
...
| and clients  |          |              |              |           |
+--------------+----------+--------------+--------------+-----------+
| Boycotting;  | > 7.4.26 | > 3 and (4   | > 3, 5 and 6 | 7 or 8    |
| anybody who  |          | > or 6)      |              |           |
| impedes,     |          |              |              |           |
| obstructs,   |          |              |              |           |
| barricades,  |          |              |              |           |
...
| classes      |          |              |              |           |
+--------------+----------+--------------+--------------+-----------+
| Cheating in  | > 7.4.27 | > 3 and (4   | > 3, 5 and 6 | 7 or 8    |
| any form     |          | > or 6)      |              |           |
| during an    |          |              |              |           |
| examination, |          |              |              |           |
| in a test,   |          |              |              |           |
...
|             |          | > OFFENSE   | > OFFENSE   | > OFFENSE   |
+=============+==========+=============+=============+=============+
| Fabrication | > 7.4.29 | > 3 and (4  | > 3, 5 and  | 7 or 8      |
| and         |          | > or 6)     | > 6         |             |
| fa          |          |             |             |             |
| lsification |          |             |             |             |
| of data,    |          |             |             |             |
...
| equirements |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| Deception   | > 7.4.30 | > 3 and (4  | > 3, 5 and  | 7 or 8      |
| or          |          | > or 6)     | > 6         |             |
| providing   |          |             |             |             |
| false       |          |             |             |             |
| information |          |             |             |             |
...
| \*          |          |             |             |             |
+-------------+----------+-------------+-------------+-------------+
| Bullying of | > 7.4.32 | 5 and 6     | 7, 8, or 9  |             |
| any kind    |          |             |             |             |
| (verbal or  |          |             |             |             |
| physical    |          |             |             |             |
| act,        |          |             |             |             |
...
+--------------+-----------+-------------+-----------+--------------+
| MINOR        | > REF No. | 1st         | 2nd       | 3rd          |
| OFFENSES     |           |             |           |              |
|              |           | > OFFENSE   | > OFFENSE | > OFFENSE    |
+==============+===========+=============+===========+==============+
| Unauthorized | 7.5.1     | 1           | 2 and 5   | > 3 and (4   |
| sale or      |           |             |           | > or 6)      |
| vending of   |           |             |           |              |
...
| preneurship) |           |             |           |              |
+--------------+-----------+-------------+-----------+--------------+
| Soliciting   | 7.5.2     | > 1 1 and 5 | 2 and 5   | > 3 and (4   |
| money or any |           |             |           | > or 6)      |
| form of      | 7.5.3     |             | 2         |              |
...
|              |           | > OFFENSE | > OFFENSE    | > OFFENSE    |
+==============+===========+===========+==============+==============+
| Violation to | 7.5.4     | 1         | 2            | > 3 and (4   |
| the          |           |           |              | > or 6)      |
| policies,    |           |           |              |              |
| rules,       |           |           |              | (Refer to    |
| guidelines,  |           |           |              |              |
...
| affection    |           |           |              |              |
+--------------+-----------+-----------+--------------+--------------+
| Violation of | 7.5.9     | 1         | 1            | > 3 and (4   |
| the school   |           |           |              | > or 6)      |
| dress code   |           |           |              |              |
| and          |           |           |              | (Refer to    |
| violation of |           |           |              |              |
...
5.  ![](media/image11.png){width="0.6233333333333333in"
    height="0.62in"}The monitoring personnel assigned to ensure the
    integrity of the collection process should be of the same sex as the
...
4.  Students who will be confirmed positive will be required to
    undertake Drug Dependency Assessment (DDA) in the
    APC--DOH-accredited laboratory to identify the dependency level and
    to identify if the student is a Dependent User (DU) or Recreational
    User (RU). This assessment is at the expense of the student.
...
![](media/image12.jpg){width="4.4837160979877515in"
height="3.354780183727034in"}
...
b.  An entire book, or a substantial past thereof, or of a musical work
...
a.  Where the works by reason of its fragile character or rarity cannot
...
a.  When copies of the work are not available in the Philippines and:
    ...
    iii. The importation, consisting of not more than three (3) such
         copies or likenesses in any one invoice, is not for sale but
         for the use only of any religious, charitable, or educational
         society or institution duly incorporated or registered, or is
         for the encouragement of the fine arts, or for any state
...
> ![](media/image13.png){width="1.2633333333333334in" height="1.27in"}
...
<!-- -->
```
a.  The APC CoursePacks will be available in MS Teams sites, arranged
    alphabetically per school.

b.  To get your required APC CoursePacks, simply join the Teams site.

c.  You are encouraged to download the APC CoursePacks of the courses
...
1.  Regular cleaning and disinfection of classrooms and offices,
    ...
    a.  Classrooms, offices, laboratories, communal areas/cafeteria, and
    ...
    b.  All areas and frequently handled objects such as doorknobs and
...
![](media/image14.png){width="5.496666666666667in"
height="8.496666666666666in"}
